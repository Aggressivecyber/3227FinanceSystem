            ...
            <main className="flex-1 flex items-center justify-center p-6 relative">
                ...
                >
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-7xl font-display font-black text-gray-900 mb-2">登录</h1>
                        <p className="text-xl text-gray-300 tracking-widest">Login</p>
                    </div>
                    ...
                    <div className="bg-white/90 rounded-[2rem] p-8 border border-gray-100 shadow-bento">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            >
                                登录系统 <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </button>

                            <div className="text-center pt-2">
                                <Link to="/register" className="inline-flex items-center gap-1 text-sm font-bold text-gray-400 hover:text-xjtu-red transition-colors">
                                    注册新账户 <span className="opacity-50 text-xs">Register</span> <ArrowRight className="w-3 h-3" />
                                </Link>
                            </div>
                        </form>
                    </div>
